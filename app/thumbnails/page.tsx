    ...
    <>
      <main className='mt-4 mb-[50px] flex flex-col'>
        ...
        <section className='mt-8 w-full'>
          <p className='my-4 font-2xl text-[30px] tracking-widest italic text-center w-full'>
            HOMEPAGE
          </p>
          ...
          <Spacer y={10} />
          <p className='my-4 font-2xl text-[30px] md:mr-[600px] tracking-widest italic text-center w-full'>
            RELATED
          </p>
